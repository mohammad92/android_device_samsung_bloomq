...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/bloomq/prebuilt/Image.gz
TARGET_PREBUILT_DTB := device/samsung/bloomq/prebuilt/dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/bloomq/prebuilt/recovery_dtbo
...
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/bloomq/bootimg.mk
...
# Dynamic Partitions
BOARD_SUPER_PARTITION_SIZE := 8274313216
BOARD_SUPER_PARTITION_GROUPS := samsung_dynamic_partitions
BOARD_SAMSUNG_DYNAMIC_PARTITIONS_SIZE := 8270118912
